...
Markdown-зеркало страницы <https://universe-design.com/en/contacts.html>.
...
UNIVERSE DESIGN делает объёмные LED-инсталляции, медиаарт и 3D-анимацию: от концепции
и 3D-визуализации до производства инсталляции и создания контента. Работает с арт-галереями,
музыкальными фестивалями, коммерческими брендами и архитектурными пространствами.

## Соцсети и площадки

- Telegram студии: <https://t.me/universe_design_studio>
...
- [Главная](https://universe-design.com/en/index.md)
- [О студии](https://universe-design.com/en/about.md)
- [Проекты](https://universe-design.com/en/projects.md)
